...
public class VisuData : MonoBehaviour
{
    ...
    public void VisualCube(float lat, float lon, float val, float multiplier)
    {
        ...
        //on donne à chaque objet une couleur allant de vert à rouge en fonction de la data d'entrée
        //Les valeurs d'entrées sont normalisées pour pouvoir rentrer dans le constructeur Color
